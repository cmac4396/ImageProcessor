...
/**
 * Represents the command to greyscale the image by its value for the Image Processor.
 */
public class ValueComponent implements ImageProcessorCommand {
  ...
  public void executeCommand(ProcessorModel model) {
    model.valueComponent(this.imageName, this.destImageName);
  }
}
