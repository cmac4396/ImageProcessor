...
/**
 * Represents the command to greyscale the image by its luma for the Image Processor.
 */
public class LumaComponent implements ImageProcessorCommand {
  ...
  public void executeCommand(ProcessorModel model) {
    model.lumaComponent(this.imageName, this.destImageName);
  }
}
